...
//Extremely OP, Designed to be broken. For EVENT USE ONLY
/obj/item/weapon/rig/adminbuse
	name = "ADMINBUSE hardsuit control module"
	desc = "Kickass and take names like only an admin can"
	icon_state = "military_rig"
	suit_type = "military hardsuit"
